...
[source,shell]
----
curl 'http://localhost:8080/api/spectura/v0/screenshot?url=https://pyjam.as&expire=2000000000'
----

If you use kitty terminal you can print the image directly in your terminal
[source,shell]
----
curl 'http://localhost:8080/api/spectura/v0/screenshot?&url=https://pyjam.as&expire=2000000000' | kitty +kitten icat
----
